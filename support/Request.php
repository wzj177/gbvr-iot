...
class Request extends \Webman\Http\Request
{
    ...
    {
        $postData = parent::post($name, $default); // TODO: Change the autogenerated stub
        (null === $name && is_array($postData) && !isset($postData['requestIp'])) && $postData['requestIp'] = $this->getRemoteIp();
