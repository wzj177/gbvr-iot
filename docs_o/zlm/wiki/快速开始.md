...
zlmediakit已上架vcpkg，便捷安装请参考[vcpkg安装zlmediakit](https://github.com/ZLMediaKit/ZLMediaKit/wiki/vcpkg%E6%96%B9%E5%BC%8F%E5%AE%89%E8%A3%85zlmediakit)
...
- 在windows系统下
  ...
  - 如果你是vs2017以下版本，你需要使用cmake-gui生成vs工程然后编译：
    ...
    5 找到目标文件并运行测试用例.
    ```
  - 同时，Windows编译也可以参考[这里](https://github.com/ZLMediaKit/ZLMediaKit/wiki/Windows-%E7%89%88%E7%BC%96%E8%AF%91%E8%AF%B4%E6%98%8E)
