...
use CoreW\Gii\Template\Easy\ExceptionTemplate;
...
class MakeBizExceptionCommand extends Command
{
    protected static $defaultName = 'make:biz-exception';
    protected static $defaultDescription = '生成业务异常类';
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $output->writeln(sprintf("正在生成Exception: %s", ShellColor::showInfo($bizId)));
