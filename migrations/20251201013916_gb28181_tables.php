...
CREATE TABLE `gv_devices` (
  ...
  `status` enum('online','offline','expired','unregistered') NOT NULL DEFAULT 'offline' COMMENT '设备状态',
...
CREATE TABLE `gv_device_channels` (
  ...
  `status` enum('online','offline','expired','unregistered') NOT NULL DEFAULT 'offline' COMMENT '通道状态',
